...
{PLUS}              {add_ops=process_pattern(add_ops,"Add operator detected.");}
{MULTIPLICATION}    {mpy_ops=process_pattern(mpy_ops,"Multiplication operator detected.");}
{POWER}             {pow_ops=process_pattern(pow_ops,"Power operator detected.");}
    
{BRACKET_LEFT}      {br_left=process_pattern(br_left,"Opening bracket detected.");}
{BRACKET_RIGHT}     {br_right=process_pattern(br_right,"Closing bracket detected.");} 
{MULTIEXPRESSION}   {multipleexpressions=process_pattern(multipleexpressions,"Multipleexpressions detected.");}
